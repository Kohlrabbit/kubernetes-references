...
module KubernetesReferences
  # https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#podaffinity-v1-core
  class PodAffinity < KubernetesReferences::API
    ...
    def _schema
      {
        preferredDuringSchedulingIgnoredDuringExecution: @preferred_during_scheduling_ignored_during_execution.map(&:schema),
        requiredDuringSchedulingIgnoredDuringExecution: @required_during_scheduling_ignored_during_execution.map(&:schema)
      }
    end
  end
end
